...
<head>
    ...
    <body>
        ...
        ?>
            <?php
                ?>
                <a class = 'acceso' href="jugar_enter_results.php?fase=fasedegrupos">Fase de Grupos</a>
                <?php
                    ...
                    <div class = 'aviso'>&#9989; Fase de Grupos enviada</div>
            ...
            {
                ?>
                <div class = 'aviso'>&#9940; Fase de grupos se encuentra cerrado</div>
                <?php   
            }
            ?>
        ...
        ?>
            <?php
                ...
                <?php
                    ...
                    <div class = 'aviso'>&#9989; Cuartos enviados</div>
            ...
            {
                ?>
                <div class = 'aviso'>&#9940; Cuartos se encuentra cerrado</div>
                <?php   
            }
            ...
            if(check_table_access($pdo, "juegos__semis")['acceso']){
                ...
                <?php    
                    ...
                    ?> 
                    <div class = 'aviso'>&#9989; Semifinales enviadas</div>  
                    <?php
            ...
            {
                ?>
                <div class = 'aviso'>&#9940; Semifinales se encuentra cerrado</div>
                <?php   
            }
            ...
            <?php
                ...
                <?php        
                    ...
                    ?>
                    <div class = 'aviso'>&#9989; Final y 3er puesto enviados</div>
                    <?php   
                }
            }
            else
            {
                ?>
                <div class = 'aviso'>&#9940; Final y 3er puesto se encuentra cerrado</div>
                <?php   
            }
            ?>
